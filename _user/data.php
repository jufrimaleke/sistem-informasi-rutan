          ...
          <div class="table-responsive22">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                    $no = 1;
                    $queryview = mysqli_query($con, "SELECT * FROM tb_user");
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#" class="btn btn-danger btn-flat" data-toggle="modal" data-target="#deleteuser<?php echo $no; ?>"><i class="glyphicon glyphicon-trash"></i></a>                      
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Apakah anda yakin ingin menghapus user <b> <?php echo $row['nama_user'];?></b><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="proses.php?act=delete&id=<?php echo $row['id_user']; ?>" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
                                ...
                                <form action="proses.php" method="post" role="form">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-8"><input type="text" class="form-control" name="nama" placeholder="Id User" value="<?php echo $row['nama_user']; ?>"></div>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="row">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-8"><input type="password" class="form-control" name="password" placeholder="Password" id="myPassword" value="<?php echo $row['pass']; ?>">
